...
define( 'ULTIMATE_DASHBOARD_PRO_PLUGIN_URL', rtrim( my_plugins_dir_url( "ultimate-dashboard-pro/dashboard-pro.php" ), '/' ) );
define( 'ULTIMATE_DASHBOARD_PRO_PLUGIN_VERSION', '3.5' );
define( 'ULTIMATE_DASHBOARD_PRO_PLUGIN_FILE', plugin_basename( "ultimate-dashboard-pro/dashboard-pro.php" ) );
...
//add_action( 'wp_loaded', 'udb_pro_plugin_updater' );
