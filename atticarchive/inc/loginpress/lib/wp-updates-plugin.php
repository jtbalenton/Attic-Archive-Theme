...
new WPUpdatesPluginUpdater_loginpress_pro( 'http://wp-updates.com/api/2/plugin', plugin_basename(LOGINPRESS_ROOT_FILE) );
*/

if( !class_exists('WPUpdatesPluginUpdater_loginpress_pro') ) {
    class WPUpdatesPluginUpdater_loginpress_pro {
    
    	public $api_url;
    	public $plugin_id = 1555;
    	public $plugin_path = '';
    	public $plugin_slug;
    	public $license_key;
