...
if ( ! class_exists( 'ACF_Frontend_Form_Main' ) ) :

	class ACF_Frontend_Form_Main {
		...
		* * * * * * * * * */
		...
		public function _hooks(){
			...
			add_filter( 'loginpress_settings_tab', array( $this, 'acf_frontend_tab' ), 10, 1 );
		...
		function _includes() {
			...
			include_once( LOGINPRESS_REDIRECT_DIR_PATH . 'classes/acf-frontend-form-define.php' );
		}
		/**
    * Load Languages
		* @since 1.0.0
    ...
    */
    public function textdomain() {
		...
		function _admin_scripts( $hook ) {
			...
			wp_enqueue_style( 'loginpress_login_redirect_stlye', LOGINPRESS_REDIRECT_ROOT_PATH . 'css/style.css', array(), LOGINPRESS_REDIRECT_VERSION );

			wp_enqueue_script( 'loginpress_login_redirect_js', my_plugins_url('js/autologin.js', 'loginpress//loginpress.php'), array( 'jquery' ), LOGINPRESS_REDIRECT_VERSION );

		}

		/**
		* [acf_frontend_tab Setting tab for Login Redirects.]
		* @param  [array] $loginpress_tabs [ Tabs of free version ]
		* @return [array]                	[ Login Redirects tab ]
		*/
		public function acf_frontend_tab( $loginpress_tabs ) {
			$_acf_frontend_tab = array(
				array(
					'id'    => 'loginpress_login_redirects',
					'title' => __( 'ACF Frontend Form', 'loginpress-login-redirects' ),
			...
			$acf_frontend_tab = array_merge( $loginpress_tabs, $_acf_frontend_tab );
			return $acf_frontend_tab;
		}
