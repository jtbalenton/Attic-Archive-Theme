...
if ( !class_exists( 'LoginPress_Settings' ) ):
  ...
  class LoginPress_Settings {
    ...
    function __construct() {
      ...
      include_once( get_stylesheet_directory() . '/inc/loginpress/classes/class-loginpress-settings-api.php' );
    ...
    function loginpress_setting_menu() {
      ...
      function loginpressicon() {
        $ttf = my_plugins_url( 'loginpressfonts/loginpress.ttf', 'loginpress/loginpress.php' );
        $woff = my_plugins_url( 'loginpressfonts/loginpress.woff', 'loginpress/loginpress.php' );
        $svg = my_plugins_url( 'loginpressfonts/loginpress.svg', 'loginpress/loginpress.php' );
        $eotie = my_plugins_url( 'loginpressfonts/loginpress.eot', 'loginpress/loginpress.php' );
        $eot = my_plugins_url( 'loginpressfonts/loginpress.eot', 'loginpress/loginpress.php' );
        echo "<style>
      @font-face {
...
$menu_slug = 'theme-features-slug';
add_menu_page( 'WP Docs Orders', 'Theme Config', 'read', $menu_slug, false,'',7);
add_submenu_page( $menu_slug, '', 'General', 'read', $menu_slug, array( $this,'plugin_page' ));
    ...
    function plugin_page() {
      ...
      esc_html_e( 'Attic Archive Beta ', 'loginpress' );
      echo '</h2>';
