...
class LoginPress_Pro {
  ...
  function _hooks() {
    ...
    add_action( 'wp_loaded',                           array( $this, 'loginpress_member_only_site' ) );
  ...
  function loginpress_pro_customizer_js() {
    ...
    wp_enqueue_script( 'loginpress-pro-customize-control',  my_plugins_url('js/customizer.js', 'loginpress/loginpress.php') , array( 'jquery', 'customize-preview' ), LOGINPRESS_VERSION, true );
  }
  ...
  */
  ...
  public function loginpress_admin_scripts( $hook ) {
			...
			wp_enqueue_script( 'jquery' );
			wp_enqueue_script( 'main-js', my_plugins_url('/js/main.js','loginpress/loginpress.php'), false, LOGINPRESS_VERSION );
  ...
  * * * * * * * * * * * */
  public function login_page_custom_head() {
    ...
    include( LOGINPRESS_PRO_DIR_PATH . 'css/style-login-pro.php' );
  }
  ...
  public function customizer_template_array( $loginpress_free_themes ) {
    ...
    while ( $_count <= 18 ) :
      ...
      $loginpress_pro_array[ "default{$_count}" ] =  array(
          'img'       => my_plugins_url("img/bg{$_count}.jpg", 'loginpress/loginpress.php') ,
          'thumbnail' => my_plugins_url("img/thumbnail/default-{$_count}.png", 'loginpress/loginpress.php') ,
          'id'        => "default{$_count}",
    ...
    $loginpress_pro_offer = array(
      'default19' => array(
        'img'       => my_plugins_url('loginpress/img/bg17.jpg', 'loginpress/loginpress.php'),
        'thumbnail' => my_plugins_url('img/thumbnail/custom-design.png', 'loginpress/loginpress.php'),
        'id'        => 'default19',
  ...
  * * * * * * * * * * * */
  ...
  public function loginpress_custom_footer(){
    ...
    include( LOGINPRESS_PRO_ROOT_PATH . '/js/script-login-pro.php' );
  }
