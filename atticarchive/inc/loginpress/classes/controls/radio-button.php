...
class LoginPress_Radio_Control extends WP_Customize_Control {
   ...
   * @return void
	...
	public function enqueue() {
		...
		wp_enqueue_script( 'loginpress-radio-control-js', my_plugins_url('js/controls/loginpress-radio-button-control.js', 'loginpress/loginpress.php') , array( 'jquery' ), '', true );
		wp_enqueue_style( 'loginpress-radio-control-css', my_plugins_url('css/controls/loginpress-radio-button-control.css','loginpress/loginpress.php') );
