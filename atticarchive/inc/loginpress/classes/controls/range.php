  ...
  */
   ...
   * @return void
	...
	public function enqueue() {
		...
		wp_enqueue_script( 'loginpress-range-control-js',my_plugins_url('js/controls/loginpress-range-control.js', 'loginpress/loginpress.php') , array( 'jquery' ),'', true );

		wp_enqueue_style( 'loginpress-range-control-css',my_plugins_url('css/controls/loginpress-range-control.css', 'loginpress/loginpress.php' ));
	}
