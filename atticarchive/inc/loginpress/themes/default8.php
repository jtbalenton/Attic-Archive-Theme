...
<?php endif; ?>
  <style media="screen" id="loginpress-style">
    ...
    body.login {
      /*background-image: url(<?php //echo my_plugin_ur( 'img/bg3-girl.jpg', LOGINPRESS_PRO_PLUGIN_BASENAME )  ?>);
    ...
    body.login:after{
      ...
      right:0;
      height: 100%;
      background: url(<?php echo my_plugin_ur( 'img/bg8.jpg', LOGINPRESS_PRO_PLUGIN_BASENAME )  ?>) no-repeat 0 0;
