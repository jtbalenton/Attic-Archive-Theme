...
<?php endif; ?>
  <style media="screen" id="loginpress-style">
    ...
    body.login {
      /*background-image: url(<?php //echo my_plugin_ur( 'img/v27_bg.jpg', LOGINPRESS_PLUGIN_BASENAME )  ?>);*/
    ...
    #login{
      background: url(<?php echo my_plugin_ur( 'img/bg17.jpg', LOGINPRESS_PRO_PLUGIN_BASENAME )  ?>) no-repeat 0 0;
      background-size: cover;
    ...
    .wp-core-ui #login  .button-primary{
      ...
      float: none;
      background-color : #f04d68;
      background-image: url(<?php echo my_plugin_ur( 'img/arrow_right.svg', LOGINPRESS_PRO_PLUGIN_BASENAME )  ?>);
