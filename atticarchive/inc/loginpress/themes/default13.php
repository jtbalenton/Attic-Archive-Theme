...
<?php endif; ?>
  <style media="screen" id="loginpress-style">
    ...
    body.login {
      background-image: url(<?php echo my_plugin_ur( 'img/bg13.jpg', LOGINPRESS_PRO_PLUGIN_BASENAME )  ?>);
    ...
    .login label[for="user_pass"]:after{
      background-image: url(<?php echo my_plugin_ur( 'img/login-field-icons.svg', LOGINPRESS_PLUGIN_BASENAME )  ?>);
    }
    .login label[for="user_login"]:after{
