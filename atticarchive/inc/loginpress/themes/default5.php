...
<?php endif; ?>
  ...
  html, body.login {
    ...
    body.login {
      background-image: url(<?php echo my_plugin_ur( 'img/bg5.jpg', LOGINPRESS_PRO_PLUGIN_BASENAME )  ?>);
    ...
    #login{
      ...
      background-image: url(<?php echo my_plugin_ur( 'img/form_bg5.jpg', LOGINPRESS_PRO_PLUGIN_BASENAME )  ?>);
      background-size: cover;
