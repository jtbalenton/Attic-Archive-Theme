...
<?php endif; ?>
  <style media="screen" id="loginpress-style">
    ...
    body.login {
      /*background-image: url(<?php echo my_plugin_ur( 'img/bg3.jpg', LOGINPRESS_PRO_PLUGIN_BASENAME )  ?>);
    ...
    #login:after{
      ...
      top: 0;
      height: 100%;
      background-image: url(<?php echo my_plugin_ur( 'img/bg10.jpg', LOGINPRESS_PRO_PLUGIN_BASENAME )  ?>);
