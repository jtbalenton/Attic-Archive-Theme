...
if ( !class_exists( 'LoginPress' ) ):
  ...
  final class LoginPress {
    ...
    private function define_constants() {
      ...
      $this->define( 'LOGINPRESS_PLUGIN_BASENAME', 'loginpress/loginpress.php' );
      $this->define( 'LOGINPRESS_DIR_PATH', get_stylesheet_directory() . '/inc/loginpress/' );
      $this->define( 'LOGINPRESS_DIR_URL', get_stylesheet_directory() .'/' );
      $this->define( 'LOGINPRESS_ROOT_PATH',  get_stylesheet_directory() . '/inc/loginpress/' );
      $this->define( 'LOGINPRESS_ROOT_FILE', 'loginpress/loginpress.php' );
    ...
    private function _hooks() {
      ...
      add_action( 'wp_loaded', array( $this, 'textdomain' ) );
    ...
    public function register_options_page() {
      ...
      add_themefeatures_page( __( 'LoginPress', 'loginpress' ), __( 'LoginPress', 'loginpress' ), 'manage_options', "abw", '__return_null' );
    }
    ...
    function _admin_scripts( $hook ) {
      ...
      if ( $hook == 'toplevel_page_loginpress-settings' || $hook == 'loginpress_page_loginpress-addons' || $hook == 'loginpress_page_loginpress-help' || $hook == 'loginpress_page_loginpress-import-export' || $hook == 'loginpress_page_loginpress-license' ) {
        ...
        wp_enqueue_style( 'loginpress_stlye', my_plugins_url( 'css/style.css', 'loginpress/loginpress.php' ) );
        wp_enqueue_script( 'loginpress_js', my_plugins_url( 'js/admin-custom.js', 'loginpress/loginpress.php' ));
