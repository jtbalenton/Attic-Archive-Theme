...
class LoginPress_Pro {
  ...
  function loginpress_pro_customizer_js() {
    ...
    wp_enqueue_script( 'loginpress-pro-customize-control', my_plugins_url( '../js/customizer.js', __FILE__ ), array( 'jquery', 'customize-preview' ), LOGINPRESS_VERSION, true );
  }
  ...
  function loginpress_pro_google_fonts() {
    ...
    if ( $loginpress_get_font ): $font_array[] = $key;
    endif;
    endforeach;
  ...
  public function loginpress_admin_scripts( $hook ) {
    ...
    wp_enqueue_script( 'jquery' );
    wp_enqueue_script( 'main-js', my_plugins_url( '../js/main.js', __FILE__ ), false, LOGINPRESS_VERSION );
  ...
  public static function has_license_expired() {
    ...
    if ( !empty( $new_license_data[ 'success' ] ) &&
