...
define( 'LOGINPRESS_PRO_ROOT_PATH', get_stylesheet_directory() . '/inc/loginpress/addons/pro' );
...
define( 'LOGINPRESS_PRO_DIR_PATH', get_stylesheet_directory(). '/inc/loginpress/addons/pro/' );
...
add_action( 'wp_loaded', 'loginpress_instance', 20 );
...
function loginpress_pro_admin_action_scripts( $hook ) {
	...
	wp_enqueue_script( 'loginpress-admin-action', my_plugins_url( 'js/admin-action.js', 'loginpress/loginpress.php' ), array( 'jquery' ), LOGINPRESS_PRO_VERSION );
...
function loginpress_pro_register_action_page() {
	...
	add_menu_page( __( 'LoginPress', 'loginpress' ), __( 'LoginPress', 'loginpress' ), 'manage_options', 'loginpress-settings', 'loginpress_pro_main_menu', my_plugins_url( 'img/icon.svg', 'loginpress/loginpress.php' ), 50 );
}
