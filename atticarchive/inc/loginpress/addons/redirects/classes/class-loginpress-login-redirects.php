    ...
    */
    public function textdomain() {
		...
		function _admin_scripts( $hook ) {
			...
			wp_enqueue_style( 'loginpress_login_redirect_stlye', LOGINPRESS_REDIRECT_ROOT_PATH . '/assets/css/style.css', array(), LOGINPRESS_REDIRECT_VERSION );

			wp_enqueue_script( 'loginpress_login_redirect_js', LOGINPRESS_REDIRECT_ROOT_PATH . '/assets/js/autologin.js', array( 'jquery' ), LOGINPRESS_REDIRECT_VERSION );
