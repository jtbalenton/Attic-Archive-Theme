...
define( 'LOGINPRESS_HIDE_ROOT_PATH', dirname( LOGINPRESS_ROOT_FILE ) );
define( 'LOGINPRESS_HIDE_PLUGIN_BASENAME', plugin_basename( LOGINPRESS_ROOT_FILE ) );
define( 'LOGINPRESS_HIDE_DIR_PATH', plugin_dir_path( LOGINPRESS_ROOT_FILE ) );
define( 'LOGINPRESS_HIDE_DIR_URL', plugin_dir_url( LOGINPRESS_ROOT_FILE ) );
define( 'LOGINPRESS_HIDE_ROOT_FILE', LOGINPRESS_ROOT_FILE );
define( 'LOGINPRESS_HIDE_PLUGIN_ROOT', dirname( plugin_basename( LOGINPRESS_ROOT_FILE ) ) );
