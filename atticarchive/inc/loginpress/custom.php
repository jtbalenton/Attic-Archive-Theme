...
class LoginPress_Entities {
  ...
  */
  function loginpress_customizer_js() {
    ...
    wp_enqueue_script( 'loginpress-customize-control', my_plugins_url(  'js/customize-controls.js' , LOGINPRESS_ROOT_FILE  ), array( 'jquery' ), LOGINPRESS_VERSION, true );
    ...
    /*
  	 ...
  	 */
  	wp_enqueue_script( 'loginpress-control-script', my_plugins_url(  'js/customizer.js' , LOGINPRESS_ROOT_FILE  ), array( 'customize-controls' ), LOGINPRESS_VERSION, true );
  ...
  function loginpress_customizer_previewer_js() {
    ...
    wp_enqueue_style( 'loginpress-customizer-previewer-style', my_plugins_url(  'css/style-previewer.css' , LOGINPRESS_ROOT_FILE  ), array(), LOGINPRESS_VERSION );

  	wp_enqueue_script( 'loginpress-customizer-previewer-script', my_plugins_url(  'js/customizer-previewer.js' , LOGINPRESS_ROOT_FILE  ), array( 'customize-preview' ), LOGINPRESS_VERSION, true );
  ...
  */
  public function customize_login_panel( $wp_customize ) {
    ...
    $wp_customize->add_panel( 'loginpress_panel', array(
      'title'						=> __( 'Login Customizer', 'loginpress' ),
    ...
    */
    $wp_customize->add_section( 'customize_presets', array(
      ...
      $loginpress_theme_name = array( "", "",
        ...
        $loginpress_free_templates["default1" ] = array(
          ...
          'img'       => esc_url( apply_filters( 'loginpress_default_bg', my_plugins_url( 'img/bg.jpg', LOGINPRESS_PLUGIN_BASENAME ) ) ),
          'thumbnail' => esc_url( apply_filters( 'loginpress_default_bg', my_plugins_url( 'img/thumbnail/default-1.png', LOGINPRESS_ROOT_FILE ) ) ),
          'id'        => 'default1',
          'name'      => 'Default'
        ) ;
        ...
        while ( $_count <= 18 ) :
          ...
          $loginpress_free_templates["default{$_count}" ] = array(
            // 'img'       => plugins_url( 'img/bg.jpg', LOGINPRESS_ROOT_FILE ),
            'thumbnail' => my_plugins_url( "img/thumbnail/default-{$_count}.png", LOGINPRESS_ROOT_FILE ),
            'id'        => "default{$_count}",
        ...
        $loginpress_free_templates["default19" ] = array(
            'img'       => my_plugins_url( 'loginpress/img/bg17.jpg', LOGINPRESS_ROOT_PATH ),
            'thumbnail' => my_plugins_url( 'loginpress/img/thumbnail/custom-design.png', LOGINPRESS_ROOT_PATH ),
            'id'        => 'default19',
    ...
    $wp_customize->add_setting( 'loginpress_customization[gallery_background]', array(
      'default'				=> my_plugins_url( "img/gallery/img-1.jpg", LOGINPRESS_ROOT_FILE ),
      'type'					=> 'option',
      'capability'		=> 'manage_options',
      'transport'     => 'postMessage'
    ) );
    ...
    while ( $bg_count <= 9 ) :
      ...
      $thumbname = my_plugins_url( "img/gallery/img-{$bg_count}.jpg", LOGINPRESS_ROOT_FILE );
      $loginpress_free_background[$thumbname] = array(
        'thumbnail' => my_plugins_url( "img/thumbnail/gallery-img-{$bg_count}.jpg", LOGINPRESS_ROOT_FILE ),
        'id'        => $thumbname,
