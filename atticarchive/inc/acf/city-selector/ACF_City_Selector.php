  ...
  class ACF_City_Selector {
    ...
    $this->define_constants();
      ...
      if ( !defined( 'ACFCS_PLUGIN_PATH' ) ) {
        $plugin_path = plugin_dir_path( "acf-city-selector/acf_city_selector.php" );
        define( 'ACFCS_PLUGIN_PATH', $plugin_path );
      }

      if ( !defined( 'ACFCS_PLUGIN_URL' ) ) {
        $plugin_url = my_plugins_dir_url( "acf-city-selector/acf_city_selector.php" );
    ...
    public function includes() {
      include 'acfcs-actions.php';
      include 'acfcs-functions.php';
      include 'acfcs-help-tabs.php';
      include 'acfcs-i18n.php';
      include 'acfcs-ajax.php';
      include 'form-handling.php';
    ...
    public function _hooks() {
      ...
      add_action( 'wp_loaded', array( $this, 'acfcs_plugin_activation' ) );
...
public function acfcs_add_scripts() {
  wp_enqueue_style( 'acfcs-general', my_plugins_url( 'assets/css/general.css', 'acf-city-selector/acf_city_selector.php' ), [], $this->settings[ 'version' ] );
  if ( is_admin() ) {
    wp_enqueue_style( 'acfcs-admin', my_plugins_url( 'assets/css/admin.css', 'acf-city-selector/acf_city_selector.php' ), [], $this->settings[ 'version' ] );
    wp_register_script( 'acfcs-admin', my_plugins_url( 'assets/js/upload-csv.js', 'acf-city-selector/acf_city_selector.php' ), [ 'jquery' ], $this->settings[ 'version' ] );
