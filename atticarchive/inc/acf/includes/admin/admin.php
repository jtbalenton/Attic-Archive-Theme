...
class ACF_Admin {
	...
	function admin_menu() {
		...
		$slug2 = "tools.php";
		$slug3="loginpress-settings";
		$cap = acf_get_setting('capability');
		
		//Add menu items.
		add_menu_page( __("Custom Fields",'acf'), __("Custom Fields",'acf'), $cap, $slug, false, 'dashicons-welcome-widgets-menus', '80.025' );
		add_submenu_page( $slug, __('Custom Field Groups','acf'), __('Custom Fields','acf'), $cap, $slug );
		add_submenu_page( $slug, __('Add New','acf'), __('Custom Fields','acf'), $cap, 'edit.php?post_type=acf-field-group' );
	}
