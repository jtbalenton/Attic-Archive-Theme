...
use Archive\Core\Common\Modules\Connect\Apps\Library;
 ...
 * Archive API.
 *
 * Archive API handler class is responsible for communicating with Archive
...
class Api {
	...
	/**
	 * Archive library option key.
	 */
	const LIBRARY_OPTION_KEY = 'Archive_remote_info_library';

	/**
	 * Archive feed option key.
	 */
	const FEED_OPTION_KEY = 'Archive_remote_info_feed_data';
	 ...
	 */
	public static $api_info_url = 'https://my.Archive.com/api/v1/info/';
	 ...
	 */
	private static $api_feedback_url = 'https://my.Archive.com/api/v1/feedback/';
	...
	private static function get_info_data( $force_update = false ) {
		$cache_key = 'Archive_remote_info_api_data_' . Archive_VERSION;
	 ...
	 * Get feed data.
	 *
	 * Retrieve the feed info data from remote Archive server.
	 *
	 * @since 1.9.0
	 * @access public
	 * @static
	 ...
	 * Send Feedback.
	 *
	 * Fires a request to Archive server with the feedback data.
	 *
	 * @since 1.0.0
	 * @access public
	 * @static
	 ...
	 * Ajax reset API data.
	 *
	 * Reset Archive library API data using an ajax call.
	 *
	 * @since 1.0.0
	 * @access public
	 * @static
	...
	public static function ajax_reset_api_data() {
		check_ajax_referer( 'Archive_reset_library', '_nonce' );
	...
	public static function init() {
		add_action( 'wp_ajax_Archive_reset_library', [ __CLASS__, 'ajax_reset_api_data' ] );
	}
}
