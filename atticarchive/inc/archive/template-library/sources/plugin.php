...
use Archive\Core\Wp_Api;
use Archive\Core\Admin\Admin;
use Archive\Core\Breakpoints\Manager as Breakpoints_Manager;
use Archive\Core\Common\Modules\Ajax\Module as Ajax;
use Archive\Core\Common\App as CommonApp;
use Archive\Core\Debug\Inspector;
use Archive\Core\Documents_Manager;
use Archive\Core\Experiments\Manager as Experiments_Manager;
use Archive\Core\Kits\Manager as Kits_Manager;
use Archive\Core\Editor\Editor;
use Archive\Core\Files\Manager as Files_Manager;
use Archive\Core\Files\Assets\Manager as Assets_Manager;
use Archive\Core\Modules_Manager;
use Archive\Core\Schemes\Manager as Schemes_Manager;
use Archive\Core\Settings\Manager as Settings_Manager;
use Archive\Core\Settings\Page\Manager as Page_Settings_Manager;
use Archive\Core\Upgrade\Archive_3_Re_Migrate_Globals;
use Archive\Modules\History\Revisions_Manager;
use Archive\Core\DynamicTags\Manager as Dynamic_Tags_Manager;
use Archive\Core\Logger\Manager as Log_Manager;
use Archive\Modules\System_Info\Module as System_Info_Module;
use Archive\Data\Manager as Data_Manager;
use Archive\Core\Common\Modules\DevTools\Module as Dev_Tools;
