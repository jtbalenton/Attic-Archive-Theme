<?php
namespace Archive\Core\Settings\Page;

use Archive\Core\Base\Document;
use Archive\Core\Files\CSS\Base;
use Archive\Core\Files\CSS\Post;
use Archive\Core\Files\CSS\Post_Preview;
use Archive\Core\Settings\Base\CSS_Manager;
...
/**
 * Archive page settings manager.
 *
 * Archive page settings manager handler class is responsible for registering
 * and managing Archive page settings managers.
 *
 * @since 1.6.0
 */
class Manager extends CSS_Manager {
	 ...
	 */
	const META_KEY = '_Archive_page_settings';
	...
	protected function print_editor_template_content( $name ) {
		?>
		<#
		const tabs = Archive.config.document.settings.tabs;
