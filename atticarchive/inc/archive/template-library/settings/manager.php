<?php
namespace Archive\Core\Settings;
 ...
 *
 * Archive settings manager handler class is responsible for registering and
 * managing Archive settings managers.
 *
 * @since 1.6.0
 */
class Manager {
	 ...
	 *
	 * Holds the names for builtin Archive settings managers.
	 *
	 * @since 1.6.0
	 * @access private
	 *
	 ...
	 *
	 * Register builtin Archive settings managers.
	 *
	 * @since 1.6.0
	 * @access private
	 * @static
