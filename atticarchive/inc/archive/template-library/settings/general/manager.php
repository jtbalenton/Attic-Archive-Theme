<?php
namespace Archive\Core\Settings\General;
 ...
 * it changed to support call like this: Manager::get_settings_managers( 'general' )->get_model()->get_settings( 'Archive_default_generic_fonts' )
...
class Manager extends CSS_Manager {
	 ...
	 */
	const META_KEY = '_Archive_general_settings';

	/**
	 * General settings manager constructor.
	 *
	 * Initializing Archive general settings manager.
	 *
	 * @since 1.6.0
	 * @access public
	 */
	public function __construct() {
		...
		remove_action( "Archive/css-file/{$name}/parse", [ $this, 'add_settings_css_rules' ] );
	}
