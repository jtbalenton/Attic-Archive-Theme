...
use Archive\Core\Files\CSS\Base as CSS_File;
...
abstract class CSS_Manager extends Manager {
	 ...
	 *
	 * Initializing Archive settings base css manager.
	 *
	 * @since 2.8.0
	 * @access public
	 */
	public function __construct() {
		...
		add_action( "Archive/css-file/{$name}/parse", [ $this, 'add_settings_css_rules' ] );
	}
	 ...
	 *
	 * Fired by `Archive/css-file/{$name}/parse` action.
	 *
	 * @since 2.8.0
	 * @access public
	 *
