...
class Search_Filter_Admin {
  ...
  private function __construct() {
    ...
    add_action( 'admin_enqueue_scripts', array( $this, 'search_filter_admin_scripts' ) );
     ...
     */
   // add_action( 'admin_head', array( $this, 'action_display_welcome_header' ) );
   ...
   */
  public function search_filter_admin_scripts() {
	...
	wp_register_style('search-filter-admin-style', my_plugins_url('css/admin.css','search_filter/admin/index.php'));
	wp_register_script('search-filter-admin', my_plugins_url('js/admin.js','search_filter/admin/index.php'), array( 'jquery' ), Search_Filter_Admin::VERSION);
	wp_register_script('search-filter-admin-posts', my_plugins_url('/js/admin-posts.js','search_filter/admin/index.php'), array( 'jquery-ui-sortable', 'jquery-ui-draggable', 'jquery' ), Search_Filter_Admin::VERSION);
	wp_enqueue_script('search-filter-admin');
	wp_enqueue_script('search-filter-admin-posts');
	wp_enqueue_style('search-filter-admin-style');
  ...
  public function enqueue_admin_scripts() {
    ...
    $screen = get_current_screen();
    if ( in_array( $screen->id, $this->plugin_screen_hook_suffix ) ) {
      wp_enqueue_script( $this->plugin_slug . '-admin-script', my_plugins_url( 'assets/js/admin.js', 'search_filter/admin/index.php' ), array( 'jquery' ), Search_Filter_Admin::VERSION );
    }
  ...
  public function add_plugin_admin_menu() {
    ...
    $iconurl = my_plugins_url( 'assets/img/icon.png', 'Search_Filter/sfp');
    $iconurl = "dashicons-search";
    $parent_slug =  "tools.php";
    $parent_slug2 = 'options-general.php';
    ...
    $this->plugin_screen_hook_suffix[ 'new_post' ] = add_submenu_page(
      $parent_slug,
      __( 'Create Search Form', $this->plugin_slug ),
      __( 'Search & Filter ', $this->plugin_slug ),
      'manage_options',
...
<div class="wrap search-filter<?php echo $hidden_class; ?>" id="search-filter-welcome-panel">
  <div class="clear"></div>
  <div class="welcome-panel"> <a class="welcome-panel-close handle-dismiss-button" data-target="#search-filter-welcome-panel" href="#"><?php printf(__('Dismiss', $this->plugin_slug)); ?></a>
    <div class="welcome-panel-content">
      <h2>
        <?php _e( 'Welcome to Search &amp; Filter', $this->plugin_slug ); ?>
      </h2>
      <p class="about-description">
        <?php _e( 'Build a custom UI for Searching &amp; Filtering your posts.', $this->plugin_slug ); ?>
      </p>
      <div class="welcome-panel-column-container">
        <div class="welcome-panel-column">
          <h4>
            <?php _e( 'Get Started', $this->plugin_slug ); ?>
          </h4>
          <p>
            <?php _e( 'If you\'ve just set up the plugin, the first thing you need to do is create a new Search Form', $this->plugin_slug ); ?>
          </p>
          <a class="button button-primary button-hero load-customize hide-if-no-customize" href="<?php echo admin_url('post-new.php?post_type=search-filter-widget'); ?>">
          <?php _e( 'Add New Search Form', $this->plugin_slug ); ?>
          </a><br />
          <br />
        </div>
        <div class="welcome-panel-column">
          <h4>
            <?php _e( 'Documentation', $this->plugin_slug ); ?>
          </h4>
          <ul>
            <li><a href="https://searchandfilter.com/documentation/getting-started/" class="welcome-icon welcome-edit-page" target="_blank">
              <?php _e( 'Getting Started with Search &amp; Filter', $this->plugin_slug ); ?>
              </a></li>
            <li><a href="https://support.searchandfilter.com/forums/forum/search-filter-pro/feature-requests/" class="welcome-icon welcome-edit-page" target="_blank">
              <?php _e( 'Feature Requests', $this->plugin_slug ); ?>
              </a></li>
          </ul>
        </div>
        <div class="welcome-panel-column welcome-panel-last">
          <h4>
            <?php _e( 'Help', $this->plugin_slug ); ?>
          </h4>
          <ul>
            <li>
              <div class="welcome-icon welcome-widgets-menus"><a href="https://searchandfilter.com/documentation/faq/" target="_blank">
                <?php _e( 'Frequently Asked Questions', $this->plugin_slug ); ?>
                </a></div>
            </li>
            <li>
              <div class="welcome-icon welcome-widgets-menus"><a href="https://support.searchandfilter.com/forums/forum/search-filter-pro/support/" target="_blank">
                <?php _e( 'Support Forums', $this->plugin_slug ); ?>
                </a></div>
            </li>
          </ul>
        </div>
...
<div class="error search-filter-wp-error-msg">
  <p>
    ...
    <a href="<?php echo admin_url('admin-ajax.php?action=search_filter_build_cache_table'); ?>">
    <?php _e('click here to create them', $this->plugin_slug); ?>
    </a> </p>
</div>
<?php
}
