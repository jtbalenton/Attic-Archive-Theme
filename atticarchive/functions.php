...
if (!function_exists('register_navwalker')) :
  function register_navwalker() {
    ...
    register_nav_menu('visitor-menu', 'Visitor Menu');
	register_nav_menu('dashboard-menu','Dashboard Menu');
...
function post_listing_parameters_shortcode( $atts ) {
  ...
  extract( shortcode_atts( array(
    'post_type' => array ('post','story','letter', 'photo', 'objects', 'article', 'document', 'ephemera', 'text', 'audio', 'video','person' ),
    'order' => 'date',
    'orderby' => 'desc',
    'posts' => 5,
    'offset' => 0,
  ...
  if ( $shortcode_query->have_posts() ): while ( $shortcode_query->have_posts() ): $shortcode_query->the_post();
...
<div class="card text-center mb-2">
  <div class="card-body">
	...
	<?php else :?>
	<img src="<?php echo get_stylesheet_directory() . '/img/no-photo-icon.png';  ?>" class="d-block w-100">  
    <?php endif; ?>
    <a href="<?php the_permalink(); ?>" class="nav-link link-warning">
    <?php the_title(); ?>
    </a> <a href="<?php the_permalink(); ?>" class="btn btn-warning mt-2">View </a> </div>
</div>
