            ...
            <div class="row mb-4">
              ...
              <div class="col-sm-9">
                <div class="d-flex justify-content-around">
                  ...
                  <?php $value = get_field( "person_birthday" ); 
                      if($value):
                      echo $value;
                          else:
                      echo "Unknown";
                  ...
                  <div class="p-2">
                    <h5 class="card-title">Died</h5>
                      <?php $value = get_field( "person_died" ); 
                      if($value):
                      echo $value;
                          else:
                      echo "Unknown";
                  ...
                  <div class="p-2">
                    ...
                    if ( $term ): ?>
                    <h6 class="card-text text-center"> <?php echo esc_html( $term->name ); ?> <h6>
                    <?php endif; ?>
                  </div>
                </div>
                ...
                <div class="d-flex justify-content-evenly">
                      ...
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <div class="container-fluid">
                            ...
                            <div class="row row-cols-4 mb-2 d-flex justify-content-evenly">
                             >
                            </div>
                  ...
                  <div class="p-2">
                    <a href="<?php the_permalink(); ?>"><button type="button" class="btn btn-warning text-white">More Info</button></a>
                  </div>
                </div>
              </div>
            </div>
